  ...
  return (
    <View style={styles.container}>
      ...
      style={styles.topGradient}>
        ...
        <Image source={require('../assets/images/Back-w.png')} style={styles.backIcon} />
        </TouchableOpacity>
        <Text style={styles.pageTitle}>Buyer Profile</Text>
      </LinearGradient>


      {/* Scrollable Content */}
      <ScrollView style={styles.scrollView} overScrollMode='never' contentContainerStyle={{ alignItems: 'center'}}>
        ...
        <View style={styles.profileContainer}>
          ...
          <View style={styles.buttonContainer}>
            ...
            <TouchableOpacity style={styles.editprofileButton} onPress={() => { /* Handle edit profile action */ }}>
            ...
            <TouchableOpacity style={styles.editphoneButton} onPress={() => { /* Handle edit phone number action */ }}>
        ...
        <View style={styles.buyHistoryContainer}>
          ...
          <Text style={styles.activeLabel}>MGA NAIBENTANG PRODUKTO</Text>
                {loading ? (
                  ...
                  <Text style={{ color: '#999', fontSize: RFValue(14), marginBottom: 20 }}>Walang data ng transaksyon.</Text>
                ) : (
